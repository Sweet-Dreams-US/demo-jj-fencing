...
export const metadata: Metadata = {
  title: "Project Gallery | JJ Fencing & Construction",
  description:
    "Real fence installations and before/after transformations across the Fox Valley. Browse by material for inspiration.",
};

...
export const metadata: Metadata = {
  title: "Our Story | JJ Fencing & Construction",
  description:
    "Family-owned and operated since 2013. A licensed, insured Wisconsin fencing contractor serving the same the Fox Valley for 13 years — and we repair any fence, even ones we didn't install.",
};

const timeline = [
  { year: "2013", text: "The family sets its first posts in Appleton. One truck, one crew, a handshake and a level." },
  { year: "2016", text: "Word spreads across the Valley — Neenah, Menasha, Kaukauna, Kimberly. Neighbors refer neighbors." },
  { year: "2020", text: "New subdivisions and pools boom. We add aluminum, vinyl and full pool-code expertise to keep up." },
  { year: "Today", text: "13 years in, same crew, same phone number, same promise: every post, set right." },
];
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2">
            <Reveal>
              ...
              <h1 className="mt-4 font-display text-4xl font-semibold leading-[1.05] text-grove sm:text-5xl">
                The Fox Valley&apos;s fence family, since 2013.
              </h1>
              <p className="mt-4 text-pretty text-lg text-ink/75">
                We&apos;re not a franchise and we&apos;re not from out of town.
                For 13 years, the same family has been building and repairing
                fences across the exact same corner of Northeast Wisconsin — the one
                we call home.
              </p>
              <p className="mt-4 text-pretty text-lg text-ink/75">
        ...
        <Container>
          <div className="grid gap-6 md:grid-cols-3">
            {[
              ...
              { icon: ShieldCheck, title: "Licensed & insured", body: "A licensed, insured Wisconsin fencing contractor. Permits pulled, code met, inspections passed." },
      ...
      <Section className="bg-grove-deep text-cream">
        <Container>
          <Reveal className="max-w-xl">
            <Eyebrow className="text-gold">13 years, one corridor</Eyebrow>

...
export default function HomePage() {
  return (
    <>
      ...
      {/* Wisconsin is different — editorial numbered */}
      <Section className="bg-cream">
        <Container>
          <div className="grid gap-12 lg:grid-cols-[1fr_1.5fr]">
            <Reveal>
              <div className="lg:sticky lg:top-28">
                <Eyebrow>The Wisconsin part</Eyebrow>
                <h2 className="mt-4 font-display text-3xl font-semibold leading-tight text-grove sm:text-4xl">
                  A fence here has three jobs a warm-weather fence never gets.
                </h2>
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2">
            <Reveal>
              ...
              <p className="mt-4 max-w-md text-lg text-ink/75">
                The the Fox Valley is one of the fastest-growing new-home
                markets in Northeast Wisconsin — and we&apos;ve fenced it town by
            ...
            <Reveal delay={120}>
              <div className="overflow-hidden rounded-3xl border border-line bg-card shadow-lg shadow-grove/5">
                <iframe
                  title="JJ Fencing & Construction service area — Appleton, Neenah, Menasha, Kaukauna, Kimberly and Oshkosh"
                  src="https://www.google.com/maps?q=Appleton,+WI&z=11&output=embed"
                  loading="lazy"

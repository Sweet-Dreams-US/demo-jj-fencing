...
export const metadata: Metadata = {
  title: "Pool Fencing & Wisconsin Code — Will Yours Pass? | JJ Fencing & Construction",
  description:
    "Take the 60-second pool-barrier self-inspection, see Wisconsin's pool-safety rules in plain English, and let us make sure you pass the real inspection the first time.",
};
      ...
      <Section className="bg-grove-deep pt-14 text-cream sm:pt-20">
        <Container>
          <div className="grid items-center gap-10 lg:grid-cols-2">
            <Reveal>
              <Eyebrow className="text-gold">Pool fencing &amp; WI code</Eyebrow>
              ...
              <p className="mt-5 max-w-md text-pretty text-lg text-cream/80">
                Wisconsin law requires a self-closing, self-latching barrier

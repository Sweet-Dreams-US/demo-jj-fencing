...
export const metadata: Metadata = {
  title: "Commercial Fencing — Pick Your Site, Read the Spec | JJ Fencing & Construction",
  description:
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2">
            <Reveal>
              ...
              <p className="mt-5 max-w-md text-pretty text-lg text-ink/75">
                ...
                facilities — 13 years of commercial work across Central
                Wisconsin, from a crew that shows up when the schedule says so.
              </p>
            ...
            <Reveal delay={120}>
              <div className="overflow-hidden rounded-3xl border border-line shadow-xl">
                ...
                <img
                  ...
                  alt="Temporary chain-link construction fencing at a Northeast Wisconsin homebuilding site"

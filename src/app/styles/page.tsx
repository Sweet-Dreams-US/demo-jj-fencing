...
export const metadata: Metadata = {
  title: "Fence Styles & Materials — Design Your Fence | JJ Fencing & Construction",
  description:
    "Watch every fence style slide across a real Northeast Wisconsin yard, then design yours: wood, aluminum, vinyl/PVC, chain link and wrought iron, with a free pre-filled estimate.",
};
        ...
        <Container>
          <Reveal className="max-w-2xl">
            ...
            <p className="mt-4 text-pretty text-lg text-ink/75">
              ...
              your name and number — and a real person from JJ Fencing & Construction

...
export const media = {
  // JJ Fencing & Construction marks — local SVGs in /public (swapped from the
  // old South Lake logos). Replace with a Higgsfield-generated raster set for the
  // final polish; the on-page chrome already reads as JJ everywhere.
  logo: `/logo-full.svg`, // stacked mark (og/social)
  logoFull: `/logo-full.svg`, // stacked full-color
  logoNav: `/logo-nav.svg`, // one-line lockup for the nav
  logoFooter: `/logo-footer.svg`, // cream mono for dark surfaces

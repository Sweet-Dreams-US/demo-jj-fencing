...
const seedLeads: Lead[] = [
  { id: "L-DANA", name: "Dana R.", town: "Neenah", phone: "(920) 555-0148", email: "dana.r@email.com", wants: "Aluminum pool fence", material: "Aluminum Ornamental", height: "5 ft", gate: "Self-closing pool gate", length: "~120 ft", addons: ["Self-closing / self-latching hardware"], via: "Styles film → Quote this style", status: "New", received: "2h ago" },
  { id: "L-MCAR", name: "Mike & Carol T.", town: "Kaukauna", phone: "(920) 555-0173", email: "mct@email.com", wants: "Storm repair — 40 ft down", material: "Wood Privacy", height: "6 ft", gate: "Single walk gate", length: "~40 ft", addons: ["Stain & seal package"], via: "Design-Your-Fence builder", status: "Called back", received: "Yesterday" },
  { id: "L-OAKG", name: "Oak Grove HOA", town: "Menasha", phone: "(920) 555-0199", email: "board@oakgrovehoa.org", wants: "Community perimeter walk-through", material: "Aluminum Ornamental", height: "6 ft", gate: "Keyed lockable gate", length: "~1,400 ft", addons: [], via: "Commercial page — site brief", status: "Visit booked", received: "Yesterday" },
  { id: "L-PRIY", name: "Priya S.", town: "Kimberly", phone: "(920) 555-0121", email: "priya.s@email.com", wants: "Wood privacy + pool-code check", material: "Wood Privacy", height: "6 ft", gate: "Double drive gate", length: "~160 ft", addons: ["Stain & seal package"], via: "Pool self-inspection → fix it", status: "Visit booked", received: "2 days ago" },
  { id: "L-JBAR", name: "J. Barnett", town: "Kaukauna", phone: "(920) 555-0110", email: "jbarnett@email.com", wants: "Wrought iron entrance", material: "Wrought Iron", height: "6 ft", gate: "Automated drive gate", length: "~90 ft", addons: ["Gate automation"], via: "Phone call", status: "Called back", received: "3 days ago" },
];
        ...
        <div className="overflow-hidden rounded-2xl border-2 border-grove/30">
          ...
          <div className="space-y-2 px-4 py-4 text-sm">
            ...
            <p>
              ...
              <span className="font-medium text-ink">
                Your JJ Fencing & Construction estimate — {justSent.project}
              </span>
            </p>

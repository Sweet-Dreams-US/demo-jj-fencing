...
/**
 * "Will it pass?" — a 60-second self-inspection against Wisconsin's
 * residential pool-barrier code, styled like the inspector's card.
 */
const QUESTIONS = [
  {
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs uppercase tracking-wide text-ink/50">
              Residential pool-barrier code · 60 seconds
            </p>
          </div>
        </div>
